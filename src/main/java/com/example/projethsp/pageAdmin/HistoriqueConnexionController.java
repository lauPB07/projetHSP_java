...
import com.example.projethsp.Repository.HistoriqueConnexionRepository;
...
public class HistoriqueConnexionController implements Initializable {
    ...
    private HistoriqueConnexionRepository repository = new HistoriqueConnexionRepository();
